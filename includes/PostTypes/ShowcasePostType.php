...
class ShowcasePostType {
	...
	public function register(): void {
		$labels = array(
			...
			'new_item'              => __( 'New 3D Item', 'three-d-showcase' ),
			'view_item'             => __( 'View 3D Item', 'three-d-showcase' ),
			'view_items'            => __( 'View 3D Items', 'three-d-showcase' ),
			'search_items'          => __( 'Search 3D Items', 'three-d-showcase' ),
			'not_found'             => __( 'No 3D items found.', 'three-d-showcase' ),
			'not_found_in_trash'    => __( 'No 3D items found in Trash.', 'three-d-showcase' ),
			'all_items'             => __( 'All 3D Items', 'three-d-showcase' ),
			'archives'              => __( '3D Item Archives', 'three-d-showcase' ),
